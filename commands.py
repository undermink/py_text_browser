...
def show_help(rows,columns) :
	...
	helpwin.addstr(5,2,"u = URL eingeben")
	#helpwin.addstr(6,2,"a = Seiteninhalt nach links scrollen")
	#helpwin.addstr(7,2,"d = Seiteninhalt nach rechts scrollen")
	helpwin.addstr(6,2,"i = Linkliste nach oben scrollen")
	helpwin.addstr(7,2,"k = Linkliste nach unten scrollen")
	helpwin.addstr(8,2,"x = Programm beenden")
	helpwin.addstr(10,2,"Pfeiltasten = Seiteninhalt scrollen")
	helpwin.refresh()
	helpwin.getch()
	helpwin.clear()
	helpwin.refresh()
